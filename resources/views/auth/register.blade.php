...
<div class="container">
    <div class="frame">
        <div class="nav">
            <ul class="links">
            <li class="signin-inactive"><a href="/login" class="btn"> Login</a></li>
                <li class="signup-active"><a class="btn">Daftar</a></li>
            </ul>
        </div>
				<form class="form-signip" action="/postregister" method="post" name="form">
			@csrf
				  <label for="nik">NIK</label>
				  <input class="form-styling" type="text" name="nik" placeholder="" />
