    ...
    <div class="frame">
        <div class="nav">
            <ul class="links">
                ...
                <li class="signup-inactive"><a href="/register" class="btn">  Daftar</a></li>
            </ul>
        </div>
		<div ng-app ng-init="checked = false">
            <form class="form-signin" action="/postlogin" method="post" name="form">
			@csrf
				 <label for="username">Email</label> <input class="form-styling" type="text" name="email" placeholder="" />
